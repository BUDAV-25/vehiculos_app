...
class AppRouter {
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/olvidar', builder: (_, __) => const ChangePasswordScreen()),
      ...
      // VEHÍCULOS
      GoRoute(path: '/vehiculos', builder: (_, __) => const MisVehiculosScreen()),
      GoRoute(path: '/vehiculo/create', builder: (_, __) => const VehiculoFormScreen()),
      ...
      GoRoute(path: '/foro/crear', builder: (_, __) => const CrearPostScreen()),
      ...
      // ACERCA DE
      GoRoute(path: '/acerca-de', builder: (_, __) => const AcercaDeScreen()),
    ],
  );
}